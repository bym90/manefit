				...
				<nav>
					<ul class="pagination">
						<li>
							...
							<a href="../Admin/AdminStock.com?nowPage=${PINFO.startPage - 1}&cate=${INFO.cate}" aria-label="Previous">
					        	<span aria-hidden="true">&laquo;</span>
					     	</a>
					     	</c:if>
						</li>
						...
						<li>
								<a href="../Admin/AdminStock.com?nowPage=${page}&cate=${INFO.cate}">${page}</a>
						</li>			
						</c:forEach>
						<li>
							<c:if test="${PINFO.endPage ne PINFO.totalPage}">
							<a href="../Admin/AdminStock.com?nowPage=${PINFO.endPage + 1}&cate=${INFO.cate}" aria-label="Next">
