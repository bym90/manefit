				...
				<nav>
					<ul class="pagination">
						<li>
							...
							<a href="../FAQ/List.com?nowPage=${PINFO.startPage - 1}" aria-label="Previous">
					        	<span aria-hidden="true">&laquo;</span>
					     	</a>
					     	</c:if>
						</li>
						...
						<li>
								<a href="../FAQ/List.com?nowPage=${page}">${page}</a>
						</li>			
						</c:forEach>
						<li>
							<c:if test="${PINFO.endPage ne PINFO.totalPage}">
							<a href="../FAQ/List.com?nowPage=${PINFO.endPage + 1}" aria-label="Next">
